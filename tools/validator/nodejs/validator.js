...
function validatePersonaProtocol(filePath) {
  ...
  if (valid) {
    console.log(`✅ Validation successful: '${filePath}' conforms to Persona Protocol v1.0.0.`);
  } else {
...
if (require.main === module) {
  ...
  validatePersonaProtocol(fileToValidate);
}